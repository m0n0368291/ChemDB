...
def ElementButton(frame,element,x,y):
	...
	w.config(width=2, height=1, borderwidth=1, highlightbackground='ghost white', background='LightSteelBlue2', 
			relief=RIDGE, font=('Arial', 12))#relief types: flat, groove, raised, ridge, solid, or sunken 
...
def search():
	''' This function takes all numerical element button values and submits an SQL query to the database.
	'''
	pattern = r"[1-9]+" #regex for one or more digits
